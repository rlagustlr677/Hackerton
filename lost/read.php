...
<tr>
    <td width=50 height=20 align=center bgcolor=#EEEEEE>연락처</td>
    <td width=240 bgcolor=white><?=$row["tell"]?></td>
...
<tr>
    ...
    <td width=240 bgcolor=white><?=$row["lwhen"]?></td>
    <td width=50 height=20 align=center bgcolor=#EEEEEE>분실장소</td>
    <td width=240 bgcolor=white><?=$row["lwhere"]?></td>
</tr>
<tr>
...
<?
    ...
    $query=mysql_query("SELECT id FROM lost_item WHERE id >$id LIMIT 1", 
    $conn);
    ...
    $query=mysql_query("SELECT id FROM lost_item WHERE id <$id 
