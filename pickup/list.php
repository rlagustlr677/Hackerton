...
if($search_word=='')
{
	$query = "SELECT * FROM pickup_item ORDER BY id DESC LIMIT $no, $page_size";
	$result_count=mysql_query("SELECT count(*) FROM pickup_item",$conn);
	$result_row=mysql_fetch_row($result_count);
	$total_row = $result_row[0];
}else{
	if($field=="title")
	{
	$query = "SELECT * FROM pickup_item where title like '%$search_word%' ORDER BY id DESC LIMIT $no, $page_size";
	$result_count=mysql_query("SELECT count(*) FROM pickup_item where title like '%$search_word%'",$conn);
	$result_row=mysql_fetch_row($result_count);
	$total_row = $result_row[0];
	}
	else if($field=="comment")
	{
	$query = "SELECT * FROM pickup_item where comment like '%$search_word%' ORDER BY id DESC LIMIT $no, $page_size";
	$result_count=mysql_query("SELECT count(*) FROM pickup_item where title like '%$search_word%'",$conn);
	$result_row=mysql_fetch_row($result_count);
	$total_row = $result_row[0];
	}
	...
	{
	$query = "SELECT * FROM pickup_item where user like '%$search_word%' ORDER BY id DESC LIMIT $no, $page_size";
	$result_count=mysql_query("SELECT count(*) FROM pickup_item where title like '%$search_word%'",$conn);
	$result_row=mysql_fetch_row($result_count);
	$total_row = $result_row[0];
	}
