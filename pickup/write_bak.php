...
<form action=insert.php method=post encrypt=multipart/form-data>
<table width=700 border=0 cellpadding=2 cellspacing=1 bgcolor=#777777>
    ...
    <tr>
	    ...
	    <tr>
		<td width=60 align=center>사진</td>
		<td align=left>
		    <INPUT type=text name=image size=15 maxlength=15>
          	</td>
		<td width=60 align=center> 분실물</td>
		<td align=left>
	    ...
	    <tr>	
 		<td width=60 align= center>분실일시</td>
		<td align=left>
